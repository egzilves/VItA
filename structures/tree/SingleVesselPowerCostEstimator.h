#ifndef TREE_SINGLEVESSELPOWERCOSTESTIMATOR_H_
#define TREE_SINGLEVESSELPOWERCOSTESTIMATOR_H_
...
/**
 * Cost estimator that user cost as l^(l_exp)*r^(r_exp) for a SINGLE VESSEL.
 */
class PowerCostEstimator: public AbstractCostEstimator {
...
#endif /* TREE_POWERCOSTESTIMATOR_H_ */
